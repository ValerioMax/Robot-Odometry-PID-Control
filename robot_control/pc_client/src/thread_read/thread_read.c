...
void *thread_read(void *args) {
    t_windata win_plotting;
    //t_windata win_odometry; // TODO
    t_info axis_info;
    CircularBuffer cbuf;
    ...
    taskdata task_data;
    task_data.windata = &win_plotting;
    task_data.cbuf = &cbuf;
    ...
    mlx_loop_hook(win_plotting.mlx, loop_task, &task_data);
    mlx_key_hook(win_plotting.win, key_handler, &axis_info);
